...
export default function Achive() {
  return (
    <>
      <div className="h-full w-full text-white gap-y-10 flex flex-col items-center justify-center overflow-x-auto pt-20 lg:pt-0">
        <p className="hidden lg:block text-white text-3xl text-left">
          All projects.
        </p>
        ...
        <Link
          className="text-sm text-white underline underline-offset-8  text-center hover:text-green-500 transition-colors duration-300 ease-in-out"
          href="/"
        >
