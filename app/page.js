...
import { CarouselSpacing } from "@/components/ProjectsCarousel";
...
export default function Home() {
  return (
    <main className={`flex flex-col gap-80 px-20 text-white ${firacode.variable} font-sans`}>
      ...
      <section className="pt-40 flex flex-col gap-y-10 pb-40 w-full">
        <p className="font-bold text-xl"><span className="text-[#00FF00]">02.</span> Projects</p>
        <div className="space-y-10 text-sm md:text-md w-[50%]">
          <CarouselSpacing/>
        </div>
      </section>
    </main>
